      ...
      <div className="container-wide section-padding relative z-10 pt-32 lg:pt-24">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            >
              <span className="block">Recupera tu</span>
            ...
            >
              Fisioterapia avanzada y entrenamiento personal con
              <span className="text-secondary font-semibold"> INDIBA</span>,
              <span className="text-secondary font-semibold"> NESA</span> y
              <span className="text-secondary font-semibold"> pilates terapéutico</span>.
            </motion.p>
            ...
            <div className="relative">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-bold text-secondary">INDIBA & NESA</p>
                    <p className="text-xs text-secondary/50">Tecnología avanzada</p>
                  </div>
                </div>
              </motion.div>
