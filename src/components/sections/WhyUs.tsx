        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-white/60 text-xl mb-12 leading-relaxed">
              Combinamos experiencia, tecnología avanzada y un trato
              cercano para ayudarte a recuperar tu bienestar.
            </p>
          ...
          >
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                { value: `+${clinic.reviews.count}`, label: "Pacientes satisfechos", icon: "Users" },
